...
public class EmployeeRoster1 {
    ...
    Employee[] employees = {
        new HourlyEmployee(1,1,1,"AMbot"),//double ratePerHour, double totalHoursWorked, int empID, String empName
    ...
    public void countHourlyEmployee() {
        ...
        System.out.println("Number of HourlyEmployee : " + count / ee.length);
    }
    ...
    public void countCommisionEmployee() {
        ...
        System.out.println("Number of CommissionEmployee : " + count / ee.length);
    }
    ...
    public void addEmployee() {
        for (int i = 0; i < employees.length; i++) {
            employees[i] = new CommisionEmployee();
        }
        System.out.println("----------New Added Employee--------------");
